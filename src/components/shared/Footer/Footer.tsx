...
const SocialIcon = ({ Icon }: any) => {
  return (
    <div className="bg-[#F2F1F1] p-3 rounded-3xl">
      <Icon size={22} />
    </div>
  );
};
...
const Footer = (props: Props) => {
  ...
  return (
    <footer className="bg-white text-black py-10 border-t mt-10">
      <div className="wrapper mt-5">
        <div className="grid md:grid-cols-5 gap-2">
          ...
          <div>
            <h2 className="text-3xl mb-5 font-extrabold">Product</h2>
          ...
          <div>
            <h2 className="text-3xl mb-5 font-extrabold">Legal</h2>
            <ul className="space-y-6">
          ...
          <div>
            <h2 className="text-3xl mb-5 font-extrabold">Resources</h2>
            <ul className="space-y-6">
              <li>FAQs</li>
              <li>Blog</li>
              <li>Career</li>
          ...
          <div>
            <h2 className="text-3xl mb-5 font-extrabold">Contact Us</h2>
            <ul className="space-y-6">
              <li>eazipay@gmail.com</li>
              <li className="underline">+(234) 904 416 0036</li>
              <Input placeholder="Your Email Address" withIcon Icon={LuSend} classNames="rounded-3xl" />
            </ul>
          </div>
        </div>
      </div>
